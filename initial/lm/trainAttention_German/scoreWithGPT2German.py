...
#tokenizer = GPT2Tokenizer.from_pretrained("gpt2-xl", cache_dir="/u/scr/mhahn/cache/")

from transformers import AutoTokenizer, AutoModelWithLMHead
  
#tokenizer = AutoTokenizer.from_pretrained("/u/scr/mhahn/cache/MANUAL/benjamin/gerpt2-large")

#model = AutoModelWithLMHead.from_pretrained("/u/scr/mhahn/cache/MANUAL/benjamin/gerpt2-large", cache_dir="/u/scr/mhahn/cache/")

from transformers import AutoModelForCausalLM, AutoTokenizer, pipeline

tokenizer = AutoTokenizer.from_pretrained("benjamin/gerpt2-large", cache_dir="/u/scr/mhahn/cache/")
model = AutoModelForCausalLM.from_pretrained("benjamin/gerpt2-large", cache_dir="/u/scr/mhahn/cache/")
...
##model = GPT2LMHeadModel.from_pretrained("gpt2-xl", pad_token_id=tokenizer.eos_token_id, cache_dir="/u/scr/mhahn/cache/").cuda()
#print("Finished loading GPT2")
#
#text = "Was denkst du denn, wer ich bin?"
