...
Datapoints = 251291
data = read.csv("analyzeFillers_freq_BNC_Spillover_Averaged_New_R.tsv", sep="\t") %>% mutate(X=NULL)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_Spillover_Averaged_New_EIS1_R.pdf", height=2, width=5)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_Spillover_Averaged_New_EIS2_R.pdf", height=2, width=5)
