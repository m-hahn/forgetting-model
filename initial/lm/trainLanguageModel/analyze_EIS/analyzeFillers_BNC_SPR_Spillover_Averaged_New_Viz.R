...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_SPR_Spillover_Averaged_New_EIS1_R.pdf", height=2, width=5)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_SPR_Spillover_Averaged_New_EIS2_R.pdf", height=2, width=5)
