...
Datapoints = 7271
data = read.csv("output/analyzeFillers_freq_BNC_TRC_Spillover_Averaged_New_R.tsv", sep="\t")
data$X=NULL
data$X.1=NULL
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_TRC_Spillover_Averaged_New_EIS1_R.pdf", height=2, width=5)
...
ggsave(plot, file="figures/analyzeFillers_freq_BNC_TRC_Spillover_Averaged_New_EIS2_R.pdf", height=2, width=5)
