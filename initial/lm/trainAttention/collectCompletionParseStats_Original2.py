import os
import sys
PATH = "/u/scr/mhahn/reinforce-logs-both/full-logs-gpt2-withOrig2/"
PATH2 = "/u/scr/mhahn/reinforce-logs-both/full-logs/"

with open(f"parsed_output/{__file__}.txt", "w") as outFile:
  print("\t".join(["ID", "DeletionRate", "Autoencoder", "NoiseLM", "PlainLM", "PredWeight", "Noun", "Continuation", "Subj", "NotSubj", "That", "NoThat"]), file=outFile)
