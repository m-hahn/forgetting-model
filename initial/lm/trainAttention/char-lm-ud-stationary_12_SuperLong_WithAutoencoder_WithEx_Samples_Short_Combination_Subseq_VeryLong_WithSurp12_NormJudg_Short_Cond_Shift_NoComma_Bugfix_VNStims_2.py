...
#      print(memory.relu(memory.memory_mlp_inner_bilinear(embedded_everything.detach())).transpose(1,2).size())
      ...
      punctuation = torch.logical_or(numeric == stoi_total["."], torch.logical_or(numeric == stoi_total["OOV"], torch.logical_or(numeric == stoi_total['"'], torch.logical_or(numeric == stoi_total["("], numeric == stoi_total[")"]))))
      ####################################################################################
...
nounsAndVerbsIncompatible.append(["the doctor", "the colleague", "mistrusted", "cured the patients", "seemed hard to believe."])
nounsAndVerbsCompatible.append(["the doctor", "the colleague", "mistrusted", "bothered the patients", "seemed hard to believe."])
...
nounsAndVerbsCompatible.append(["the criminal", "the stranger", "distracted", "baffled the officer", "seemed concerning."])
...
nounsAndVerbsIncompatible.append(["the banker", "the analyst", "defrauded", "trusted the customer", "proved to be made up."])
nounsAndVerbsCompatible.append(["the banker", "the analyst", "defrauded", "excited the customer", "proved to be made up."])
...
nounsAndVerbsCompatible.append(["the captain", "the crew", "trusted", "emboldened the sailor", "was nice to hear."])
...
nounsAndVerbsIncompatible.append(["the drunkard", "the thug", "hit", "outwitted the bartender", "sounded hilarious."])
nounsAndVerbsCompatible.append(["the drunkard", "the thug", "hit", "stunned the bartender", "sounded hilarious."])
nounsAndVerbsIncompatible.append(["the pediatrician", "the receptionist", "supported", "mistrusted the parent", "troubled people."])
...
nounsAndVerbsCompatible.append(["the medic", "the survivor", "thanked", "flummoxed the surgeon", "turned out to be untrue."])
nounsAndVerbsIncompatible.append(["the lifesaver", "the soldier", "taught", "rescued the swimmer", "pleased the townspeople."])
nounsAndVerbsCompatible.append(["the lifesaver", "the soldier", "taught", "encouraged the swimmer", "pleased the townspeople."])
...
nounsAndVerbsIncompatible.append(["the investor", "the scientist", "detested", "deceived the entrepreneur", "taught everyone a lesson."])
nounsAndVerbsCompatible.append(["the investor", "the scientist", "detested", "disappointed the entrepreneur", "taught everyone a lesson."])
nounsAndVerbsIncompatible.append(["the firefigher", "the neighbor", "insulted", "rescued the houseowner", "struck John as implausible."])
nounsAndVerbsCompatible.append(["the firefigher", "the neighbor", "insulted", "disheartened the houseowner", "struck John as implausible."])
nounsAndVerbsIncompatible.append(["the vendor", "the storeowner", "recruited", "welcomed the client", "excited the boss."])
nounsAndVerbsCompatible.append(["the vendor", "the storeowner", "recruited", "enchanted the client", "excited the boss."])
...
nounsAndVerbsIncompatible.append(["the sponsor", "the musician", "entertained", "cheered the onlookers", "pleased everone."])
nounsAndVerbsCompatible.append(["the sponsor", "the musician", "entertained", "captivated the onlookers", "pleased everone."])
