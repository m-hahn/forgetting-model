...
data = read.csv("/u/scr/mhahn/reinforce-logs-both-short/stimuli-full-logs-tsv/collectResults_Stims.py_TaborHutchins.tsv", sep="\t")
...
ggsave(plot, file="taborHutchins_vanillaLSTM_smoothed.pdf", height=10, width=10)
