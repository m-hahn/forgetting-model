...
assert False, "unfinished rewrite of stimuli"
nounsAndVerbsIncompatible.append(["the teacher", "the principal", "liked", "failed everyone", "was only a malicious smear ."])
nounsAndVerbsCompatible.append(["the teacher", "the principal", "liked", "annoyed everyone", "was only a malicious smear ."])
nounsAndVerbsIncompatible.append(["the doctor", "the colleague", "distrusted", "cured patients", "seemed hard to believe ."])
nounsAndVerbsCompatible.append(["the doctor", "the colleague", "distrusted", "bothered patients", "seemed hard to believe ."])
nounsAndVerbsIncompatible.append(["the bully", "the children", "hated", "harassed the others", "was entirely correct ."])
nounsAndVerbsCompatible.append(["the bully", "the children", "hated", "shocked the others", "was entirely correct ."])
nounsAndVerbsIncompatible.append(["the agent", "the fbi", "sent", "arrested criminals", "was acknowledged ."])
nounsAndVerbsCompatible.append(["the agent", "the fbi", "sent", "confused criminals", "was acknowledged ."])
...
nounsAndVerbsIncompatible.append(["the sponsor", "the musician", "entertained", "cheered onlookers", "pleased everyone ."])
nounsAndVerbsCompatible.append(["the sponsor", "the musician", "entertained", "captivated onlookers", "pleased everyone ."])
