...
parser.add_argument("--learning_rate_lm", type = float, default= random.choice([0.0005])) # 0.0005 was identified as the best hyperparameter for optimizing predictability quite clearly (August 2021)
