...
plot = plot +  scale_fill_gradient2() + facet_wrap(~denoiser+lm)
ggsave(plot, file="model2_german_lm.pdf")
...
plot = plot +  scale_fill_gradient2() + facet_wrap(~denoiser+lm)
ggsave(plot, file="model1_german_lm.pdf")
...
plot = plot +  scale_fill_gradient2() + facet_wrap(~denoiser+lm)
ggsave(plot, file="sanity2_german_lm.pdf")
...
plot = plot +  scale_fill_gradient2() + facet_wrap(~denoiser+lm)
ggsave(plot, file="sanity1_german_lm.pdf")
