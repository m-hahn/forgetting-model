 ...
 for f in os.listdir(PATH):
   ...
   if shib in f and "ZERO" in f:
      ...
      if True or accept:
          ...
          try:
           with open(PATH2+f+"_ZeroLoss", "r") as inFile:
             print("Opened", PATH2+f+"_ZeroLoss")
             ...
             print("Couldn't open", PATH2+f+"_ZeroLoss")
             pass
