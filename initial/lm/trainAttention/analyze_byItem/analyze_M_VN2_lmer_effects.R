data = read.csv("/juice/scr/mhahn/reinforce-logs-both-short/full-logs-tsv-perItem/collect12_NormJudg_Short_Cond_W_GPT2_ByTrial_VN2.py.tsv", sep="\t")
...
sink("analyze_M_VN2_lmer_effects.R.txt")
