data = read.csv("/juice/scr/mhahn/reinforce-logs-both-short/full-logs-tsv-perItem/char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_Subseq_VeryLong_WithSurp12_NormJudg_Short_Cond_Shift_NoComma_Bugfix_J_3_W_GPT2L_ZEROV.py_807687648_ZeroLoss", sep="\t")
library(tidyr)
library(dplyr)
library(lme4)
...
ggsave(plot, file="figures/analyze_ZEROV_L.R.pdf", height=8, width=8)
...
ggsave(plot, file="figures/analyze_ZEROV_L.R_slopes_hist.pdf", height=8, width=8)
...
ggsave(plot, file="figures/analyze_ZEROV_L.R_comparison_slopes.pdf", width=10, height=10)
