...
# The ordering of slopes closely replicates -- so it is a property of GPT2 and stable across multiple runs of the memory model. It is even similar for GPT2L!
