...
nounsAndVerbs.append(["der Geigenspieler",   "den die Sponsoren",    "unterstützten",          "Drogen nahm",            "stimmt wahrscheinlich", "Was the XXXX likely true?", "Y"])
...
nounsAndVerbs.append(["der Taxifahrer", "den der Tourist", "fragte", "log", "schien schwer zu glauben", "", "Y"])
