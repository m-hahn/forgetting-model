...
header0 = "Sentence Region Word EISReweighted SurprisalReweighted Copy".split(" ")
...
PATH2 = "/juice/scr/mhahn/reinforce-logs-both-short/calibration-full-logs-tsv-EIS/"

with open(f"{PATH2}/{__file__}.tsv", "w") as outFile:
 print("\t".join(header), file=outFile)
 for f in sorted(os.listdir(PATH2)):
   shib = "errorIdentification_Erasure4_Fillers"
   if shib in f:
