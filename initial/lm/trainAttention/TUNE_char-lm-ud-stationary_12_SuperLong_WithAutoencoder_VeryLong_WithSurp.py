...
scripts.append("char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_Subseq_VeryLong_WithSurp12_NormJudg_Short_Cond_Shift_NoComma_Bugfix_VNStims_2.py")
...
# 0.35, 0.4, 0.45, 0.5, 0.55, 
   ...
   command = ["/u/nlp/anaconda/main/anaconda3/envs/py37-mhahn/bin/python", random.choice(scripts), "--tuning=1", "--deletion_rate="+deletion_rate, "--predictability_weight="+str(random.choice([0.0])), "--learning_rate_memory="+str(random.choice([0.00001, 0.00002, 0.00005, 0.0001]))] #, "--predictability_weight=0.0"]
   print(command)
