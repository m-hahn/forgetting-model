...
model1 = (lmer(FPASSD ~ SurprisalReweighted.x + SurprisalReweighted.y + WLEN + LogBNCFreq + WLEN + LogBNCFreq + (1|Identifier) + (1|SUBJ), data=data, REML=F))
...
#model2 = (lmer(FPASSD ~ SurprisalReweighted.y + WLEN + LogBNCFreq + WLEN*LogBNCFreq + (1|Identifier) + (1|SUBJ), data=data, REML=F))
   ...
   sink("analyze_model2_Joint.R.tsv", append=TRUE)
