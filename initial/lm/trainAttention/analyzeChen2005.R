...
data = read.csv("/u/scr/mhahn/reinforce-logs-both-short/stimuli-full-logs-tsv/collectResults_Stims.py_Chen2005.tsv", sep="\t")
...
ggsave(plot, file="chen2005_vanillaLSTM_smoothed.pdf", height=10, width=10)
