...
import sys
ID = sys.argv[1]
with open(f"/u/scr/mhahn/reinforce-logs-both/full-logs-gpt2-withOrig2/char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_Subseq_VeryLong_WithSurp12_Sampling_GPT2.py_{ID}", "w") as outFile:
