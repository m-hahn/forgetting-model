...
for i in range(20): # 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 
# 0.35, 0.4, 0.45, 0.5, 0.55, 
   deletion_rate = str(0.0) #str(random.choice([0.65, 0.7, 0.75])) #, 0.25, 0.3, 0.35])) # , 0.4, 0.45, 0.5, 0.55      #[0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6]))
