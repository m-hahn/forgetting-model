...
#            thatProbs2 = sum([1.0 if NOUN+" that" in x else 0 for x in result])/len(result)
#            for q in range(len(result)):
 #             print(result[q], NOUN+" that" in result[q])
  #            print(" ".join([itos_total[int(x)] for x in resultNumeric[:,q]]))
   #         quit()
#            print("thatProbsCompare", thatProbs, thatProbs2)
