...
scripts.append("char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_NoLM.py")
scripts.append("char-lm-ud-stationary_12_SuperLong_WithAutoencoder_WithEx_Samples_Short_Combination_NoLM_NoPos.py")
...
# 0.35, 0.4, 0.45, 0.5, 0.55, 
   ...
   predictability_weight = str(random.choice([0.0])) #, 0.5, 0.6, 0.7]))     #[0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 0.6]))
