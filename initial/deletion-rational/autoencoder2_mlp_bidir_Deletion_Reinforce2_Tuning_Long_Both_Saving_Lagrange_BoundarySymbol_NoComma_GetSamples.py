...
parser.add_argument("--load-from-joint", dest="load_from_joint", type=str, default=random.choice([264724444, 678404162, 727830817]))
...
if args.load_from_joint is not None:
 # try:
  ...
  checkpoint = torch.load("/u/scr/mhahn/CODEBOOKS_memoryPolicy_both/"+args.language+"_"+"autoencoder2_mlp_bidir_Deletion_Reinforce2_Tuning_Long_Both_Saving_Lagrange_BoundarySymbol_NoComma.py"+"_code_"+str(args.load_from_joint)+".txt")
