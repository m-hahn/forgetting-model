...
with open(f"output/{__file__}.tsv", "w") as outFile:
 ...
 for filename in files:
   ...
   if len(glob.glob("/u/scr/mhahn/noisy-channel-logs/deletion-ferreira/autoencoder2_mlp_bidir_Deletion_Reinforce2_Tuning_Long_Both_Saving_Lagrange_BoundarySymbol_NoPunct_GetSamples3_Fer.py_"+ID)) == 0:
        subprocess.call(["/u/nlp/anaconda/main/anaconda3/envs/py37-mhahn/bin/python", "autoencoder2_mlp_bidir_Deletion_Reinforce2_Tuning_Long_Both_Saving_Lagrange_BoundarySymbol_NoPunct_GetSamples3_Fer.py", "--load-from-joint="+ID])
   with open("/u/scr/mhahn/noisy-channel-logs/deletion-ferreira/autoencoder2_mlp_bidir_Deletion_Reinforce2_Tuning_Long_Both_Saving_Lagrange_BoundarySymbol_NoPunct_GetSamples3_Fer.py_"+ID, "r") as inFile:
